...
def test_datasets_and_tables_created(
    ...
    test_data_dld_table: bigquery.table.Table = session.get_table(
        "test_test_data.device_level_data"
    )
    test_data_device_freq_table: bigquery.table.Table = session.get_table(
        "test_test_data._device_frequencies"
    )
    test_data_device_strata_table: bigquery.table.Table = session.get_table(
        "test_test_data._device_strata"
    )
